...
export default function SettingsPage() {
  ...
  async function onSave(e: FormEvent) {
    ...
    try {
      ...
      setSaved("WhatsApp settings saved");
      await refresh();
    } catch (err) {
  ...
  return (
    <div className="grid split-2 page-scroll">
      ...
      <form className="panel form" onSubmit={onSave}>
        <h2>Shop WhatsApp credentials</h2>
        <p className="muted">Owners can self-serve front-facing WhatsApp without waiting on Master Admin.</p>
